...
Email: gil.bueno@simpli.com.br

Date: Aug 7 2018

"""
from simpli.txio import get_asset_attachments
from simpli.token import *
from simpli.crowdsale import *
from simpli.nep5 import *
from boa.interop.Neo.Runtime import GetTrigger, CheckWitness
from boa.interop.Neo.TriggerType import Application, Verification
from boa.interop.Neo.Storage import *

ctx = GetContext()
NEP5_METHODS = ['newWallet', 'name', 'symbol', 'decimals', 'totalSupply', 'balanceOf', 'transfer', 'transferFrom', 'approve', 'allowance']
